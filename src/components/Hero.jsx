...
const Hero = () => {
  ...
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className="text-[#915EFF]">kamran ikram official</span>
          </h1>
      ...
      <div className="w-full h-[260px] xs:h-[300px] sm:h-[360px] md:h-[420px] lg:h-[480px] mt-10 relative z-0 pointer-events-auto" style={{ pointerEvents: 'none' }}>
        <ComputersCanvas />
      </div>

      <div className="absolute xs:bottom-10 bottom-32 w-full flex justify-center items-center z-50 pointer-events-auto" style={{ pointerEvents: 'auto' }}>
        <a href="#about">
